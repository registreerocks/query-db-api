...
from .helpers import _get_short_response, _get_query_result, _get_aggregate, _get_demographic_query_result
...
@mock.patch('src.swagger_server.controllers.create._query_bulk')
def test_query_degree_demographics(query_result, mock_mongo_aggregate):
    query_result.return_value = _get_short_response()
    mock_mongo_aggregate.return_value = _get_aggregate()
    ...
    expected_output = _get_demographic_query_result()
    assert(_query_degree(details) == expected_output)
